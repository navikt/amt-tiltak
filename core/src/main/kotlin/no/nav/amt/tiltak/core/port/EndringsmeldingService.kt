...
interface EndringsmeldingService {
	...
	fun opprettEndreDeltakelseProsentEndringsmelding(deltakerId: UUID, arrangorAnsattId: UUID, deltakerProsent: Int, dagerPerUke: Float?, gyldigFraDato: LocalDate?):UUID
