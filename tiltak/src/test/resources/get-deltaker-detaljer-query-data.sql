...
INSERT INTO deltaker (id, bruker_id, gjennomforing_id, start_dato, slutt_dato, status, dager_per_uke, prosent_stilling,
                      registrert_dato)
VALUES ('dc600c70-124f-4fe7-a687-b58439beb214', '23b04c3a-a36c-451f-b9cf-30b6a6b586b8',
        'b3420940-5479-48c8-b2fa-3751c7a33aa2', 'yesterday'::DATE, 'tomorrow'::DATE, 'DELTAR', 5, 100,
        'yesterday'::DATE);
