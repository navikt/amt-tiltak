...
internal class TiltaksinstansRepositoryTest {
	...
	companion object TestData {
		...
		val TILTAKSARRANGOR_ID = UUID.fromString("0dc9ccec-fd1e-4c4e-b91a-c23e6d89c18e")
	}
	...
	internal fun `insert() should insert tiltaksinstans and return object`() {
		...
		val savedInstans = repository.insert(
			arenaId = arenaId,
			tiltakId = TILTAK_ID,
			tiltaksarrangorId = TILTAKSARRANGOR_ID,
			navn = navn,
			status = status,
		...
		assertEquals(TILTAKSARRANGOR_ID, savedInstans.tiltaksarrangorId)
