...
import no.nav.amt.tiltak.tiltaksarrangor.TiltaksarrangorRepository
...
internal class TiltaksarrangorRepositoryTest {

	val dataSource = SingletonPostgresContainer.getDataSource()

	lateinit var repository: TiltaksarrangorRepository
	...
	fun migrate() {
		...
		repository = TiltaksarrangorRepository(NamedParameterJdbcTemplate(dataSource))

		DatabaseTestUtils.cleanDatabase(dataSource)
	}

	@Test
	internal fun `insert() should insert tiltaksarrangor and return the object`() {
